...
LOCAL_CFLAGS =   -Os -Wall -DCONFIG_YAFFS_UTIL -DCONFIG_YAFFS_DOES_ECC
...
LOCAL_MODULE := steam_mkyaffs2image
...
LOCAL_CFLAGS+=   -DS_IWRITE=0200 -DS_IREAD=0400
LOCAL_C_INCLUDES += $(LOCAL_PATH)/yaffs2
LOCAL_MODULE := libsteam_mkyaffs2image
LOCAL_CFLAGS += -Dmain=steam_mkyaffs2image_main
include $(BUILD_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libsteam_unyaffs
...
LOCAL_CFLAGS+=   -DS_IWRITE=0200 -DS_IREAD=0400
LOCAL_C_INCLUDES += $(LOCAL_PATH)/yaffs2
LOCAL_CFLAGS += -Dmain=steam_unyaffs_main
include $(BUILD_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := steam_unyaffs
LOCAL_SRC_FILES := yaffs2/utils/unyaffs.c
